...
public class Main {
    public static void main(String[] args) {
        String strData = "5 2 7 1 9 3 8 6 0 4"; //"Darwin Brisbane Perth Melbourne Canberra Adelaide Sydney Canberra";
        ...
        myLinkedList.removeItem(new Node("11"));
        myLinkedList.traverse(myLinkedList.getRoot());
        ...
        */
        ...
        strData = "5 2 7 1 9 3 8 6 0 4";
        String [] data2 = strData.split(" ");

        SearchTree myBinarySearchTree = new SearchTree(null);

        for (String str: data2)
            myBinarySearchTree.addItem(new Node(str));

        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());
        myBinarySearchTree.removeItem(new Node("3"));
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());

        myBinarySearchTree.removeItem(new Node("5"));
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());

        myBinarySearchTree.removeItem(new Node("0"));
        myBinarySearchTree.removeItem(new Node("4"));
        myBinarySearchTree.removeItem(new Node("2"));
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());

        myBinarySearchTree.removeItem(new Node("9"));
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());
        myBinarySearchTree.removeItem(new Node("8"));
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());
        myBinarySearchTree.removeItem(new Node("6"));
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());
        myBinarySearchTree.removeItem(myBinarySearchTree.getRoot());
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());
        myBinarySearchTree.removeItem(myBinarySearchTree.getRoot());
        myBinarySearchTree.traverse(myBinarySearchTree.getRoot());
    }
