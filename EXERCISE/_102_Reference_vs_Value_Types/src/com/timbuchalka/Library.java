...
public class Library {
    ...
    public static int IncreaseTheArraySizeQuestion(){
        System.out.print("Enter new array size: ");
        return scanner.nextInt();
    }

    public static int[] IncreaseTheArraySize(int[] myIntArray, int newSize){
        return Arrays.copyOf(myIntArray, newSize);
    }

    public static void InsertNewArrayElements(int[] myIntArray, int startingIndex){
        for (int i = startingIndex; i < myIntArray.length; i++){
            System.out.print("Enter a num: ");
            myIntArray[i] = scanner.nextInt();
        }
    }
