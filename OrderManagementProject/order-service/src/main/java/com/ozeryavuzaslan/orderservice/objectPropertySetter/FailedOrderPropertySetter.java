...
public interface FailedOrderPropertySetter {
    ...
    FailedOrderDTO setSomeProperties(OrderDTO orderDTO, RollbackPhase rollbackPhase, RollbackReason rollbackReason, List<ReservedStockDTO> reservedStockDTOList);
}
