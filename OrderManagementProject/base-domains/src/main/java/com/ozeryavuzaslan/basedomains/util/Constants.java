...
public final class Constants {
    public static final String STOCK_ENDPOINT = "/stocks/getByProductName/{name}";
    ...
    public static final String CATEGORY_NOT_FOUND = "The requested stock is not found! Consider add new category.";
