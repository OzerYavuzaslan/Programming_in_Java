...
@NoArgsConstructor
@AllArgsConstructor
public class DecreaseStockQuantityDTO implements Comparable<DecreaseStockQuantityDTO>{
    ...
    @Override
    public int compareTo(DecreaseStockQuantityDTO o) {
        return getProductCode().compareTo(o.productCode);
    }
}
