package com.ozeryavuzaslan.revenueservice.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.ozeryavuzaslan.revenueservice..*)" +
            " || within(com.ozeryavuzaslan.revenueservice.configuration..*)" +
            " || within(com.ozeryavuzaslan.revenueservice.controller..*)" +
            " || within(com.ozeryavuzaslan.revenueservice.exception..*)" +
            " || within(com.ozeryavuzaslan.revenueservice.model..*)" +
            " || within(com.ozeryavuzaslan.revenueservice.repository..*)" +
            " || within(com.ozeryavuzaslan.revenueservice.service..*)" +
            " || within(com.ozeryavuzaslan.revenueservice.util..*)")
