...
public class LoginScreen extends javax.swing.JFrame
{
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        boolean login_successful = process.login_method(username, password);
        
        if(login_successful)
        {
            EmployeeScreen emp_screen = new EmployeeScreen(this, true);
            setVisible(false);
            emp_screen.setVisible(true);
            System.exit(0);
        }
        else
            messageLabel.setText("Login is failed! Please try again.");
